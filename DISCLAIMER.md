# First Minutes — Legal fence (2026-09-06)

Status: Legal draft fence for a first-aid wait helper / information pack. Sellable faceless SKU. Not a licensed attorney or medical opinion.
...
## Web app / footer + first-run (fuller)
...
Age: Not for unsupervised under-18 use for emergency decisions — a responsible adult should act.

## Hard no’s for copy
Don’t claim: doctor, nurse, paramedic, “diagnoses,” “treats,” emergency dispatch, guaranteed ambulance ETA, “covers your medical aid,” HPCSA-registered, replaces first-aid certification, or that DEMO/unverified facility data is live.

## Product UI requirement
Emergency call prompt (112 / local emergency) must appear on first open and on any “emergency / severe” path — not only in ToS. Clearly label DEMO / unverified facility data until Build marks it verified.

Escalate before: live dispatch, symptom checkers that claim triage, under-18 targeting, or partnerships implying clinical endorsement.
